# torch-controls Specification

## Purpose
Define the consolidated player tool controls: `SPACE` performs Debugger inspection, and plain `G` uses the Interference Torch for reversible infrastructure interference.
## Requirements
