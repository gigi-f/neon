# layer-visibility Specification

## Purpose
Defines player-facing layer overlays that make existing simulation state readable at map level without requiring detailed inspection panels for every entity.
