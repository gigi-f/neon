# municipal-access Specification

## Purpose
Expose small municipal access records on public sites so the player can inspect and locally spoof institutional service gates without adding health, appointment, faction, public-works, or city-wide surveillance systems.
## Requirements
